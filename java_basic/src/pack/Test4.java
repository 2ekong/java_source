...
public class Test4 {
	public static void main(String[] args) {
		...
		System.out.println(a>=3 && b<10 || b==10);
		...
		ij = ii << 1;	//죄측으로 1bit 이동, 남는 우측은 0으로 채움
		System.out.println("ij: " + ij+ " " + Integer.toBinaryString(ij));
		
		ij = ii >> 2;	//우측으로 2bit 이동, 남는 좌측은 같은 값으로 채움, 양수는 0, 음수는 1
		System.out.println("ij: " + ij+ " " + Integer.toBinaryString(ij));
		...
		int sbs = 6;
		int result = (sbs > 5)?100:20 + 30;	//(조건)?참일때 처리문:거짓일때 처리문
